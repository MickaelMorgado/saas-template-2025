...
const PricingCard: FC<Pricing> = (props) => {
	return (
		<div className="bg-card text-card-foreground p-6 rounded-lg flex flex-col gap-4 w-[350px] border border-border shadow-lg">
			<div className="flex w-full items-center justify-between">
				...
				{props.popular && (
					<Badge className="bg-primary text-primary-foreground p-2 rounded-full px-4">
						Popular
					</Badge>
				)}
			</div>
